 ...
 */
MTLClearColor mvkMTLClearColorFromVkClearValue(VkClearValue vkClearValue, VkFormat vkFormat);
...
MTLTextureType mvkMTLTextureTypeFromVkImageType(VkImageType vkImageType, uint32_t arraySize, bool isMultisample);
...
/** Returns the Metal texture usage from the Vulkan image usage taking into considertion usage limits for the pixel
 * format. */
...
mvkMTLMultisampleDepthResolveFilterFromVkResolveModeFlagBits(VkResolveModeFlagBits vkResolveMode);
...
mvkMTLMultisampleStencilResolveFilterFromVkResolveModeFlagBits(VkResolveModeFlagBits vkResolveMode);
#endif
...
#define MVK_VK_MEMORY_TYPE_METAL_SHARED                                                                                \
 ...
 */
#define MVK_VK_MEMORY_TYPE_METAL_MANAGED                                                                               \
    (VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT | VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_CACHED_BIT)

/** Macro indicating the Vulkan memory type bits corresponding to Metal memoryless memory (not host visible and lazily
 * allocated). */
#define MVK_VK_MEMORY_TYPE_METAL_MEMORYLESS                                                                            \
