...
public:
	...
	{
		mCol[3] = Vec4(inV, 1.0f);
	}
	JPH_INLINE Vec3 GetDiagonal3() const
	{
		return Vec3(mCol[0][0], mCol[1][1], mCol[2][2]);
	}
	...
	{
		return Vec4(mCol[0][0], mCol[1][1], mCol[2][2], mCol[3][3]);
	}
