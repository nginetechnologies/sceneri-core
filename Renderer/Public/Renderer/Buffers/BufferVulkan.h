...
namespace ngine::Rendering
{
...
#if RENDERER_VULKAN
	struct BufferVulkan : public BufferBase
	{
		using BufferBase::BufferBase;
	protected:
		~BufferVulkan();

		// Fran: TODO: These should probably be turned into constructors/destructors
		// Arguments should be packed in structs
	...
	using DeviceBuffer = BufferVulkan;
#endif
}
