		...
		: mRenderer(inRenderer)
	{
		...
		switch (format)
		{
			case ESurfaceFormat::A4L4:
				...
				break;
			case ESurfaceFormat::L8:
				desc.Format = DXGI_FORMAT_R8_UNORM;
				break;
			case ESurfaceFormat::A8:
			...
			case ESurfaceFormat::X1R5G5B5:
				...
				format = ESurfaceFormat::A1R5G5B5;
				break;
			case ESurfaceFormat::X4R4G4B4:
				desc.Format = DXGI_FORMAT_B4G4R4A4_UNORM;
				format = ESurfaceFormat::A4R4G4B4;
				break;
			case ESurfaceFormat::A1R5G5B5:
				desc.Format = DXGI_FORMAT_B5G5R5A1_UNORM;
				break;
			...
			case ESurfaceFormat::R8G8B8:
				...
				format = ESurfaceFormat::X8R8G8B8;
				break;
			...
			case ESurfaceFormat::A8R8G8B8:
				...
				break;
			case ESurfaceFormat::A8B8G8R8:
				desc.Format = DXGI_FORMAT_B8G8R8A8_UNORM;
				format = ESurfaceFormat::A8R8G8B8;
				break;
		...
		FatalErrorIfFailed(inRenderer->GetDevice()->CreateCommittedResource(
			&heap_properties,
