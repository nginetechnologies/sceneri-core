...
#if !defined(HAS_SOCKLEN_T) && !defined(__socklen_t_defined) && !PLATFORM_ANDROID && !PLATFORM_EMSCRIPTEN
...
{
	const ngine::Time::Timestamp currentTime = ngine::Time::Timestamp::GetCurrent();
	return (enet_uint32)currentTime.GetMilliseconds();
}
