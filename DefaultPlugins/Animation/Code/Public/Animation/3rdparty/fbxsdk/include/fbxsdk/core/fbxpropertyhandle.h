	...
	* with the normal limits. */
	//@{
		...
		* \return The minimum value of this property */
		template <class T> inline T GetMin(const T*) const { T lValue; GetMin(&lValue, FbxTypeOf(lValue)); return lValue; }
		...
		* \return The soft minimum value of this property */
		template <class T> inline T GetSoftMin(const T*) const { T lValue; GetSoftMin(&lValue, FbxTypeOf(lValue)); return lValue; }
		...
		* \return The maximum value of this property */
		template <class T> inline T GetMax(const T*) const { T lValue; GetMax(&lValue, FbxTypeOf(lValue)); return lValue; }
		...
		* \return The soft maximum value of this property */
		template <class T> inline T GetSoftMax(const T*) const { T lValue; GetSoftMax(&lValue, FbxTypeOf(lValue)); return lValue; }
	//@}
	...
	*/
	//@{
		...
		* \return The gotten property value. */
		template <class T> inline T Get(const T*) const { T lValue; Get(&lValue, FbxTypeOf(lValue)); return lValue; }
	//@}
