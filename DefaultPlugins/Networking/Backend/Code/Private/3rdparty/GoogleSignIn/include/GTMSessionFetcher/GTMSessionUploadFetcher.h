...
typedef void (^GTMSessionUploadFetcherDataProviderResponse)(NSData *_Nullable data, int64_t fullUploadLength,
...
typedef void (^GTMSessionUploadFetcherCancellationHandler)(GTMSessionFetcher *_Nullable fetcher, NSData *_Nullable data,
                                                           NSError *_Nullable error);
...
- (void)setUploadDataLength:(int64_t)fullLength provider:(nullable GTMSessionUploadFetcherDataProvider)block;
