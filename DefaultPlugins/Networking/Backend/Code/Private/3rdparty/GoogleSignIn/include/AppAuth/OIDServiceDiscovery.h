...
/*! @brief Decodes a OpenID Connect Discovery 1.0 JSON document.
    ...
    @param error If a required field is missing from the dictionary, an error with domain
        ...
        returned.
 */
- (nullable instancetype)initWithJSON:(NSString *)serviceDiscoveryJSON error:(NSError **_Nullable)error;
...
/*! @brief Decodes a OpenID Connect Discovery 1.0 JSON document.
    ...
    @param error If a required field is missing from the dictionary, an error with domain
        ...
        returned.
 */
- (nullable instancetype)initWithJSONData:(NSData *)serviceDiscoveryJSONData error:(NSError **_Nullable)error;
