 ...
 *   FreeType error code.  0~means success.
 */
FT_EXPORT(FT_Error) __cdecl FT_Get_MM_Var(FT_Face face, FT_MM_Var** amaster);
 ...
 *   FreeType error code.  0~means success.
 */
FT_EXPORT(FT_Error) __cdecl FT_Done_MM_Var(FT_Library library, FT_MM_Var* amaster);
 ...
 *   2.9
 */
FT_EXPORT(FT_Error) __cdecl FT_Set_Named_Instance(FT_Face face, FT_UInt instance_index);
