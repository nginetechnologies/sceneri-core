...
PUSH_MSVC_WARNINGS
DISABLE_MSVC_WARNINGS(4324 4310 4458 4100 4296 4701 4334 4127 4548 4242 4244 4267 4255)

PUSH_CLANG_WARNINGS
DISABLE_CLANG_WARNING("-Wcast-qual")
DISABLE_CLANG_WARNING("-Wcast-align")
DISABLE_CLANG_WARNING("-Wimplicit-int-conversion")
DISABLE_CLANG_WARNING("-Wtautological-type-limit-compare")
DISABLE_CLANG_WARNING("-Wsign-comparison")
DISABLE_CLANG_WARNING("-Wshorten-64-to-32")
DISABLE_CLANG_WARNING("-Wdeclaration-after-statement")
