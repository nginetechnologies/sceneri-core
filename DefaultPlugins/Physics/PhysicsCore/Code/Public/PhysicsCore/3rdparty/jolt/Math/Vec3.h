...
/// Note that we keep the 4th component the same as the 3rd component to avoid divisions by zero when JPH_FLOATING_POINT_EXCEPTIONS_ENABLED
/// defined
...
public:
	...
	JPH_INLINE Vec3(const ngine::Math::Vector3f& inV)
		: Vec3(inV.x, inV.y, inV.z)
	{
	}
	[[nodiscard]] JPH_INLINE operator ngine::Math::Vector3f() const
	{
