...
@property (nullable, nonatomic, weak) id<GTMAppAuthFetcherAuthorizationTokenRefreshDelegate> tokenRefreshDelegate;
...
- (instancetype)initWithAuthState:(OIDAuthState *)authState
              ...
              userEmailIsVerified:(nullable NSString *)userEmailIsVerified NS_DESIGNATED_INITIALIZER;
