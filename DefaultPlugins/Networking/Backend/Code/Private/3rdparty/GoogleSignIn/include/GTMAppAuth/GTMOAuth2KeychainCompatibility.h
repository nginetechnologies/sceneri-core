 ...
 */
+ (NSString *)persistenceResponseStringForAuthorization:(GTMAppAuthFetcherAuthorization *)authorization;
 ...
 */
+ (nullable GTMAppAuthFetcherAuthorization *)authorizeFromKeychainForName:(NSString *)keychainItemName
...
/*! @brief Attempts to create a @c GTMAppAuthFetcherAuthorization from a @c NSString
    ...
    @return A @c GTMAppAuthFetcherAuthorization object, or nil.
 */
+ (nullable GTMAppAuthFetcherAuthorization *)authorizeFromPersistenceString:(NSString *)persistenceString
                                                                   tokenURL:(NSURL *)tokenURL
                                                                redirectURI:(NSString *)redirectURI
                                                                   clientID:(NSString *)clientID
                                                               clientSecret:(nullable NSString *)clientSecret;
...
+ (BOOL)saveAuthToKeychainForName:(NSString *)keychainItemName
    ...
    __attribute__((deprecated("Use GTMAppAuthFetcherAuthorization::saveAuthorization:toKeychainForName:")));
...
/*! @brief Attempts to create a @c GTMAppAuthFetcherAuthorization from data stored in the keychain
    ...
    @return A @c GTMAppAuthFetcherAuthorization object, or nil.
 */
+ (nullable GTMAppAuthFetcherAuthorization *)authForGoogleFromKeychainForName:(NSString *)keychainItemName
                                                                     clientID:(NSString *)clientID
                                                                 clientSecret:(nullable NSString *)clientSecret;
