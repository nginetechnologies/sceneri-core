...
template<class T>
inline T EvaluatePropertyValue(FbxProperty& pProperty, const FbxTime& pTime, bool pForceEval = false);
...
public:
	 ...
	 * \param pCheckForDup			If \c true, parent property checks if it has a child property already with pName, if \c false, the new
	 * property is created. \param pWasFound			If pCheckForDup is \c true, this flag is set to indicate whether the pCompoundProperty
	 * already has a child property with pName.
	 */
	 ...
	 * \param pCheckForDup			If \c true, parent property checks if it already has a child property that has the name of pFromProperty, if
	 * \c false, a new property is created. \remark						Only the property name, label, min/max, enums and flags are copied.
	 */
	 ...
	 * \param pFromProperty	The property copied by this property.
	 * \param pCheckForDup		If \c true, pObject checks if it already has a property that has the name of pFromProperty, if \c false, a new
	 * property is created. \remark					Only the property name, label, min/max, enums and flags are copied.
	 */
	 ...
	 * \return \c True if this property is valid and pValue doesn't equal zero, or this property is invalid and pValue equals zero, \c false
	 * otherwise.
	 */
	...
	/** Non-equivalence operator.
	 * \param pValue The value compared to this property.
	 * \return \c True if this property is valid and pValue equals zero, or this property is invalid and pValue doesn't equal zero, \c false
	 * otherwise.
	 */
	inline bool operator!=(int pValue) const
	{
	...
	//! This is an internal class that you can use to build and clear the name map of properties. You can use the name map to speed up
	//! searching for property names.
	 ...
	 * \param pAnimLayer The animation layer to test for curve presence. Set to NULL if you want to use the default animation layer of the
	 * default animation stack. \return \c true if the property is animated. */
	 ...
	 * \param pTime The time used for evaluate. If FBXSDK_TIME_INFINITE is used, this returns the default value, without animation curves
	 * evaluation. \param pForceEval Force the evaluator to refresh the evaluation state cache even if its already up-to-date. \return The
	 * property value at the specified time converted to the template type provided, if possible. \remark If the property type versus the
	 * template cannot be converted, the result is unknown. */
	template<class T>
	 ...
	 * \param pTime The time used for evaluate. If FBXSDK_TIME_INFINITE is used, this returns the default value, without animation curves
	 * evaluation. \param pForceEval Force the evaluator to refresh the evaluation state cache even if its already up-to-date. \return The
	 * property value at the specified time. */
	...
	/** Returns the number of source objects which are of the specified class type and satisfy the given criteria with which this property
	 * connects. \tparam T The specified class type. \param pCriteria The given criteria. \return The number of source objects which are of
	 * the specified class type and satisfy the given criteria.
	 */
	template<class T>
	 ...
	 * \param pCriteria The given criteria.
	 * \param pIndex The specified index whose default value is 0.
	 * \return The source object which is of the specified class type and satisfies the given criteria at the specified index, NULL if not
	 * found.
	 */
	template<class T>
	...
	/** Searches the source object with the specified name which is of the specified class type and satisfies the given criteria, starting
	 * with the specified index. \tparam T The specified class type. \param pCriteria The given criteria. \param pName The object name. \param
	 * pStartIndex The start index. \return The source object with the name, NULL if not found.
	 */
	template<class T>
	...
	/** Returns the number of destination objects which are of the specified class type and satisfy the given criteria with which this
	 * property connects. \tparam T The specified class type. \param pCriteria The given criteria. \return The number of destination objects
	 * which are of the specified class type and satisfy the given criteria with which this property connects.
	 */
	template<class T>
	...
	/** Returns the destination object which is of the specified class type and satisfies the given criteria at the specified index with which
	 * this property connects. \tparam T The specified class type. \param pCriteria The given criteria. \param pIndex The specified index
	 * whose default value is 0. \return The destination object which is of the specified class type and satisfies the given criteria at the
	 * specified index, NULL if not found.
	 */
	template<class T>
	...
	/** Searches the destination object with the specified name which is of the specified class type and satisfies the given criteria,
	 * starting with the specified index. \tparam T The specified class type. \param pCriteria The given criteria. \param pName The object
	 * name. \param pStartIndex The start index. \return The source object with the name, NULL if not found.
	 */
	template<class T>
...
private:
	...
	friend void FbxMarkObject(
		FbxObject* pObject,
		FbxMap<FbxObject*, int>& pObjectDstDisconnectCount,
		FbxSet<FbxObject*>& pObjectsToDeleted,
...
public:
	 ...
	 */
	FbxProperty& StaticInit(
		FbxObject* pObject, const char* pName, const T& pValue, bool pForceSet, FbxPropertyFlags::EFlags pFlags = FbxPropertyFlags::eNone
	)
	{
