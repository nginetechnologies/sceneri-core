...
#include <Animation/3rdparty/fbxsdk/include/fbxsdk/core/fbxsymbol.h>
...
// Enum list        
    ...
    template <class T> inline T     Get( FbxInt pId, const T*)  { T lValue; Get( pId,&lValue,FbxTypeOf(lValue) ); return lValue; }
