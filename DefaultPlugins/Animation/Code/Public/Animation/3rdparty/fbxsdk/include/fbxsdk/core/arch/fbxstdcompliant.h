...
#include <Animation/3rdparty/fbxsdk/include/fbxsdk/fbxsdk_nsbegin.h>
	...
	inline int FBXSDK_sprintf(char* dst, [[maybe_unused]] size_t dstsize, const char* format, ...){ va_list vl; va_start(vl, format); int ret = vsnprintf(dst, dstsize, format, vl); va_end(vl); return ret; }
	...
	inline int FBXSDK_vsprintf(char* dst, [[maybe_unused]] size_t dstsize, const char* format, va_list vl){ return vsnprintf(dst, dstsize, format, vl); }
