...
namespace ngine::Rendering
{
	...
	struct RoundedRectangleLinearGradientPipeline final : public GraphicsPipeline
	{
		RoundedRectangleLinearGradientPipeline(Rendering::LogicalDevice& logicalDevice);
		RoundedRectangleLinearGradientPipeline(const RoundedRectangleLinearGradientPipeline&) = delete;
		RoundedRectangleLinearGradientPipeline& operator=(const RoundedRectangleLinearGradientPipeline&) = delete;
		RoundedRectangleLinearGradientPipeline(RoundedRectangleLinearGradientPipeline&& other) = default;
		RoundedRectangleLinearGradientPipeline& operator=(RoundedRectangleLinearGradientPipeline&&) = delete;
