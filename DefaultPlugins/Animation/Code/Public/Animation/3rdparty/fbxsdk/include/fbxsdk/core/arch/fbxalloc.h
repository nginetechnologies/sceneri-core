...
typedef void*	(__cdecl *FbxMallocProc)(size_t);			//! Function pointer signature used to replace "malloc"
typedef void*	(__cdecl *FbxCallocProc)(size_t, size_t);	//! Function pointer signature used to replace "calloc"
typedef void*	(__cdecl *FbxReallocProc)(void*, size_t);	//! Function pointer signature used to replace "realloc"
typedef void	(__cdecl *FbxFreeProc)(void*);				//! Function pointer signature used to replace "free"
...
FBXSDK_DLL void __cdecl FbxSetMallocHandler(FbxMallocProc pHandler);
...
FBXSDK_DLL void __cdecl FbxSetCallocHandler(FbxCallocProc pHandler);
...
FBXSDK_DLL void __cdecl FbxSetReallocHandler(FbxReallocProc pHandler);
...
FBXSDK_DLL void __cdecl FbxSetFreeHandler(FbxFreeProc pHandler);
...
*****************************************************************************************************************************/
	...
	FBXSDK_DLL size_t __cdecl FbxAllocSize(size_t pNbItems, size_t pItemSize);
	FBXSDK_DLL void* __cdecl FbxMalloc(size_t pSize);
	FBXSDK_DLL void* __cdecl FbxCalloc(size_t pCount, size_t pSize);
	FBXSDK_DLL void* __cdecl FbxRealloc(void* pData, size_t pSize);
	FBXSDK_DLL void __cdecl FbxFree(void* pData);
	FBXSDK_DLL char* __cdecl FbxStrDup(const char* pString);
	FBXSDK_DLL wchar_t* __cdecl FbxStrDupWC(const wchar_t* pString);
