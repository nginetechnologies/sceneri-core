...
constexpr VkStructureType VK_STRUCTURE_TYPE_INSTANCE_LAYER_SETTINGS_EXT = static_cast<VkStructureType>(VK_STRUCTURE_TYPE_MAX_ENUM - 42);
...
VkResult vkEnumerateInstanceLayerSettingsEXT(const char* pLayerName, uint32_t* pSettingCount, VkLayerSettingDescriptionEXT* pSettings);

VkResult vkEnumerateInstanceLayerSettingOptionEXT(
	const char* pLayerName, const char* pSettingName, uint32_t* pSettingOptionCount, VkLayerSettingOptionEXT* pSettingOptions
);
