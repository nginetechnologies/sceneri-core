...
namespace ngine::Rendering
{
	...
	struct RoundedBorderRectanglePipeline final : public GraphicsPipeline
	{
		RoundedBorderRectanglePipeline(Rendering::LogicalDevice& logicalDevice);
		RoundedBorderRectanglePipeline(const RoundedBorderRectanglePipeline&) = delete;
		RoundedBorderRectanglePipeline& operator=(const RoundedBorderRectanglePipeline&) = delete;
		RoundedBorderRectanglePipeline(RoundedBorderRectanglePipeline&& other) = default;
		RoundedBorderRectanglePipeline& operator=(RoundedBorderRectanglePipeline&&) = delete;
