...
public:
	...
	/// Constructor
	explicit					WheelTV(WheelSettingsTV &inWheel);
...
protected:
	...
	virtual Wheel *				ConstructWheel(WheelSettings &inWheel) const override { JPH_ASSERT(IsKindOf(&inWheel, JPH_RTTI(WheelSettingsTV))); return new WheelTV(static_cast<WheelSettingsTV &>(inWheel)); }
