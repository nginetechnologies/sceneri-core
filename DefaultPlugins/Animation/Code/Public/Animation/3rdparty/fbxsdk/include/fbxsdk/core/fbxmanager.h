...
public:
	...
	//@{
		/** SDK manager allocation method.
		  ...
		  */
		static FbxManager* __cdecl Create();
	...
	//@{
		/** Get FBX SDK version string.
		  ...
		  */
		static const char* __cdecl GetVersion(bool pFull=true);
	...
	//@{
		...
		/** Override class.
		  ...
		  * \return The class Id
		  */
		template <typename T1,typename T2> inline FbxClassId OverrideFbxClass(const T1*, const T2* )
		{
