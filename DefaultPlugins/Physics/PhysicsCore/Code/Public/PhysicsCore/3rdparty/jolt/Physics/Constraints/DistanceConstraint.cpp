	...
	mWorldSpacePosition2(inSettings.mPoint2)
{
	...
	{
        mWorldSpacePosition1 = inBody1.GetWorldTransform() * mLocalSpacePosition1;
        mWorldSpacePosition2 = inBody2.GetWorldTransform() * mLocalSpacePosition2;
        
        mLocalSpacePosition1 = inBody1.GetInverseCenterOfMassTransform() * mWorldSpacePosition1;
		mLocalSpacePosition2 = inBody2.GetInverseCenterOfMassTransform() * mWorldSpacePosition2;
    }
	else
	{
