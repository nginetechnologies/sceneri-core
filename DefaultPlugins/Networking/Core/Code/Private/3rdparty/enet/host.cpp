...
PUSH_MSVC_WARNINGS
DISABLE_MSVC_WARNINGS(4245 5054)
...
ENetPeer* enet_host_connect(ENetHost* host, const ENetAddress* address, size_t channelCount, enet_uint32 data)
{
	...
	currentPeer->connectID = ngine::Math::Random<enet_uint32>();
	...
	command.connect.channelCount = ENET_HOST_TO_NET_32((uint32_t)channelCount);
...
void enet_host_bandwidth_throttle(ENetHost* host)
{
	enet_uint32 timeCurrent = enet_time_get(), elapsedTime = timeCurrent - host->bandwidthThrottleEpoch,
							peersRemaining = (enet_uint32)host->connectedPeers, dataTotal = ~0, bandwidth = ~0, throttle = 0, bandwidthLimit = 0;
