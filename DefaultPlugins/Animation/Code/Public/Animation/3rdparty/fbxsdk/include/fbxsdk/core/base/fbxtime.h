...
public:
	 ...
	 */
	static double __cdecl GetFrameRate(EMode pTimeMode);
	...
	FbxString GetTimeString(
		EElement pStart = eHours, EElement pEnd = eResidual, EMode pTimeMode = eDefaultMode, EProtocol pTimeFormat = eDefaultProtocol
	) const;
