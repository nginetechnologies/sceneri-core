...
#define VK_MVK_MOLTENVK_EXTENSION_NAME "VK_MVK_moltenvk"
	...
	typedef enum MVKConfigTraceVulkanCalls
	{
		...
		MVK_CONFIG_TRACE_VULKAN_CALLS_ENTER_EXIT = 2, /**< Log the name of each Vulkan call when the call is entered and exited. This
		...
		MVK_CONFIG_TRACE_VULKAN_CALLS_DURATION =
			3, /**< Same as MVK_CONFIG_TRACE_VULKAN_CALLS_ENTER_EXIT, plus logs the time spent inside the Vulkan function. */
