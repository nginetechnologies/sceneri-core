...
namespace JPH::DebugRendering
{
		...
		: mRenderer(inRenderer)
	{
		...
		pso_desc.RasterizerState.CullMode = inCullMode == ECullMode::Backface
		                                      ? D3D12_CULL_MODE_FRONT
		                                      : D3D12_CULL_MODE_BACK; // DX uses left handed system so we reverse the options
