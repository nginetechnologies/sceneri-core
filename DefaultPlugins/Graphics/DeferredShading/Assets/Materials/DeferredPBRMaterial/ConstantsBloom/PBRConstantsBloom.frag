...
#endif
{
	...
	layout(offset = 40) float emissive;
} pushConstants;
...
void main()
{
    outColor.xyz = pushConstants.color.rgb;
#if OUTPUT_DEPTH
	...
	outMaterialProperties.xyzw = vec4(pushConstants.metallic, pushConstants.roughness, pushConstants.emissive, 1.0);
