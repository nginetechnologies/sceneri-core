...
namespace JPH::DebugRendering
{
	...
	public:
		/// Constructor
		RenderPrimitive(Renderer* inRenderer, D3D_PRIMITIVE_TOPOLOGY inType)
		...
		int GetNumVtxToDraw() const
		{
			return mNumVtxToDraw;
		}
		void SetNumVtxToDraw(int inUsed)
		{
			mNumVtxToDraw = inUsed;
		}
		...
		int GetNumIdxToDraw() const
		{
			return mNumIdxToDraw;
		}
		void SetNumIdxToDraw(int inUsed)
		{
			mNumIdxToDraw = inUsed;
		}
