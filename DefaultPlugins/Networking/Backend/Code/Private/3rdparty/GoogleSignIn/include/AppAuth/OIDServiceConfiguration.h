 ...
 */
typedef void (^OIDServiceConfigurationCreated)(OIDServiceConfiguration *_Nullable serviceConfiguration,
 ...
 */
- (instancetype)initWithAuthorizationEndpoint:(NSURL *)authorizationEndpoint tokenEndpoint:(NSURL *)tokenEndpoint;
