 ...
 */
FT_EXPORT(FT_Error)
__cdecl FT_Init_FreeType(FT_Library* alibrary);
 ...
 */
FT_EXPORT(FT_Error)
__cdecl FT_New_Memory_Face(FT_Library library, const FT_Byte* file_base, FT_Long file_size, FT_Long face_index, FT_Face* aface);
 ...
 */
FT_EXPORT(FT_Error)
__cdecl FT_Done_Face(FT_Face face);
 ...
 */
FT_EXPORT(FT_Error)
__cdecl FT_Request_Size(FT_Face face, FT_Size_Request req);
 ...
 */
FT_EXPORT(FT_Error)
__cdecl FT_Set_Char_Size(FT_Face face, FT_F26Dot6 char_width, FT_F26Dot6 char_height, FT_UInt horz_resolution, FT_UInt vert_resolution);
 ...
 */
FT_EXPORT(FT_Error)
__cdecl FT_Set_Pixel_Sizes(FT_Face face, FT_UInt pixel_width, FT_UInt pixel_height);
 ...
 */
FT_EXPORT(FT_Error)
__cdecl FT_Load_Glyph(FT_Face face, FT_UInt glyph_index, FT_Int32 load_flags);
 ...
 */
FT_EXPORT(FT_Error)
__cdecl FT_Render_Glyph(FT_GlyphSlot slot, FT_Render_Mode render_mode);
 ...
 */
FT_EXPORT(FT_UInt)
__cdecl FT_Get_Char_Index(FT_Face face, FT_ULong charcode);
 ...
 */
FT_EXPORT(FT_ULong)
__cdecl FT_Get_First_Char(FT_Face face, FT_UInt* agindex);
 ...
 */
FT_EXPORT(FT_ULong)
__cdecl FT_Get_Next_Char(FT_Face face, FT_ULong char_code, FT_UInt* agindex);
...
FT_EXPORT(FT_Error)
FT_Get_SubGlyph_Info(
	FT_GlyphSlot glyph, FT_UInt sub_index, FT_Int* p_index, FT_UInt* p_flags, FT_Int* p_arg1, FT_Int* p_arg2, FT_Matrix* p_transform
);
