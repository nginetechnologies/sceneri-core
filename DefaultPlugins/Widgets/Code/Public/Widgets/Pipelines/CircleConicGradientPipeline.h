...
namespace ngine::Rendering
{
	...
	struct CircleConicGradientPipeline final : public GraphicsPipeline
	{
		CircleConicGradientPipeline(Rendering::LogicalDevice& logicalDevice);
		CircleConicGradientPipeline(const CircleConicGradientPipeline&) = delete;
		CircleConicGradientPipeline& operator=(const CircleConicGradientPipeline&) = delete;
		CircleConicGradientPipeline(CircleConicGradientPipeline&& other) = default;
		CircleConicGradientPipeline& operator=(CircleConicGradientPipeline&&) = delete;
