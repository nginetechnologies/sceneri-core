...
#include <Physics/Constraints/ConstraintPart/RackAndPinionConstraintPart.h>
...
public:
	...
	/// The constraints that constrain the rack and pinion (a slider and a hinge), optional and used to calculate the position error and fix
	/// numerical drift.
	void SetConstraints(const Constraint* inPinion, const Constraint* inRack)
	{
		mPinionConstraint = inPinion;
		mRackConstraint = inRack;
	}
