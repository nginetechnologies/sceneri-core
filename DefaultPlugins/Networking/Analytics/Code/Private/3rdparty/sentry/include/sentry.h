 ...
 */
SENTRY_API sentry_value_t __cdecl sentry_value_new_null(void);

/**
 * Creates a new 32-bit signed integer value.
 */
SENTRY_API sentry_value_t __cdecl sentry_value_new_int32(int32_t value);
 ...
 */
SENTRY_API sentry_value_t __cdecl sentry_value_new_string(const char *value);
SENTRY_API sentry_value_t __cdecl sentry_value_new_string_n(
    const char *value, size_t value_len);

/**
 * Creates a new list value.
 */
SENTRY_API sentry_value_t __cdecl sentry_value_new_list(void);
 ...
 */
SENTRY_API int __cdecl sentry_value_set_by_key(
    sentry_value_t value, const char *k, sentry_value_t v);

SENTRY_API int __cdecl sentry_value_set_by_key_n(
 ...
 * have to call `sentry_value_decref` on it.
 */
SENTRY_API int __cdecl sentry_value_append(sentry_value_t value, sentry_value_t v);
 ...
 */
SENTRY_API sentry_value_t __cdecl sentry_value_new_event(void);
 ...
 */
SENTRY_EXPERIMENTAL_API sentry_value_t __cdecl sentry_value_new_exception(
    const char *type, const char *value);
SENTRY_EXPERIMENTAL_API sentry_value_t __cdecl sentry_value_new_exception_n(
 ...
 */
SENTRY_EXPERIMENTAL_API sentry_value_t  __cdecl sentry_value_new_stacktrace(
    void **ips, size_t len);
 ...
 */
SENTRY_EXPERIMENTAL_API void __cdecl sentry_event_add_exception(
 ...
 * stack trace instruction pointers are attached to the event.
 */
SENTRY_EXPERIMENTAL_API void __cdecl sentry_event_value_add_stacktrace(
 ...
 */
SENTRY_API sentry_options_t * __cdecl sentry_options_new(void);
...
SENTRY_API void __cdecl sentry_options_set_dsn_n(
 ...
 */
SENTRY_API void __cdecl sentry_options_set_sample_rate(
...
SENTRY_API void __cdecl sentry_options_set_release_n(
...
SENTRY_API void __cdecl sentry_options_set_environment_n(
...
SENTRY_API void __cdecl sentry_options_set_dist_n(
...
SENTRY_API void __cdecl sentry_options_set_ca_certs_n(
 ...
 */
SENTRY_API void __cdecl sentry_options_set_debug(sentry_options_t *opts, int debug);
 ...
 *
 */
SENTRY_API void __cdecl sentry_options_set_logger(
...
SENTRY_API void sentry_options_set_database_path(
    sentry_options_t *opts, const char *path);
SENTRY_API void __cdecl sentry_options_set_database_path_n(
    sentry_options_t *opts, const char *path, size_t path_len);
...
SENTRY_API void __cdecl sentry_options_add_attachmentw_n(
...
SENTRY_API void sentry_options_set_handler_pathw(
    sentry_options_t *opts, const wchar_t *path);
SENTRY_API void __cdecl sentry_options_set_handler_pathw_n(
    sentry_options_t *opts, const wchar_t *path, size_t path_len);
...
SENTRY_API void sentry_options_set_database_pathw(
    sentry_options_t *opts, const wchar_t *path);
SENTRY_API void __cdecl sentry_options_set_database_pathw_n(
    sentry_options_t *opts, const wchar_t *path, size_t path_len);
#endif
 ...
 * Returns 0 on success.
 */
SENTRY_API int __cdecl sentry_init(sentry_options_t *options);
 ...
 */
SENTRY_API int __cdecl sentry_close(void);
 ...
 */
SENTRY_API sentry_uuid_t __cdecl sentry_capture_event(sentry_value_t event);
 ...
 */
SENTRY_EXPERIMENTAL_API void __cdecl sentry_options_set_traces_sample_rate(
    sentry_options_t *opts, double sample_rate);
...
SENTRY_EXPERIMENTAL_API sentry_transaction_context_t * __cdecl
 ...
 */
SENTRY_EXPERIMENTAL_API sentry_transaction_t * __cdecl sentry_transaction_start(
 ...
 * is finished.
 */
SENTRY_EXPERIMENTAL_API sentry_uuid_t __cdecl sentry_transaction_finish(
 ...
 * status.
 */
SENTRY_EXPERIMENTAL_API void __cdecl sentry_transaction_set_status(
